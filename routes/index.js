...
// 角色
router.get('/api/system/role', userRequired, role.getRole);
...
router.post('/api/system/roles', userRequired, role.addAndSave);
router.put('/api/system/roles', userRequired, role.update);
router.delete('/api/system/roles/:id', userRequired, role.delete);

router.get('/api/system/room', userRequired, room.getRoom);
